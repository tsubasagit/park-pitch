  ...
  return (
    <div
      className="
        ...
        prose-table:my-2
        prose-hr:my-3
        prose-blockquote:my-2 prose-blockquote:border-park-navy/30
        ...
        prose-a:text-park-orange prose-a:no-underline hover:prose-a:underline
        prose-strong:text-park-navy
      "
    >
